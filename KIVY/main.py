...
class CalculatorWidget(GridLayout):
    #Berfungsi untuk inisialisai dari Kivy
    #Panjang Lebar Button, Ukuran Font
...
class CalculatorApp(App):
    def build(self):
        ...
        Config.write()
        #mengembalikan nilai dari Class CalculatorWidget
        return CalculatorWidget()

    
#Pemanggilan class CalculatorAPP
